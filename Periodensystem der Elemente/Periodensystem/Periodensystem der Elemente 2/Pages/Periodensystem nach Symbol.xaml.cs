...
{
    /// <summary>
    /// Interaktionslogik für Periodensystem_nach_Symbol.xaml
    /// </summary>
    public partial class Periodensystem_nach_Symbol : Page
    {
        public Periodensystem_nach_Symbol(Window owner)
        {
            InitializeComponent();
            Owner = owner;
